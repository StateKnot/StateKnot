...
application-persisted model stream sink, production accounting/result
evidence, durable transcript assembly inside the prebuilt graph, full crash reconciliation supervision,
